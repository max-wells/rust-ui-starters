...
use crate::toaster_custom::types::Toast;
use crate::toaster_custom::{
    toast_id::ToastId,
    types::{decode_message, HeightT, ToasterPosition},
};
...
pub fn ToastContainer(
    ...
    let delete_toast = move || {
        ...
        set_timeout(
            move || {
                ...
                leptos::Callable::call(&remove_toast, toast.id);
            },
    ...
    let class = create_memo(move |_| {
        tw_merge!(
            ...
            "absolute opacity-0 outline-none box-border",
        )
    });
