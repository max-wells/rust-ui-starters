...
function MultiSelectTag(el, customs = { shadow: false, rounded: true }) {
	...
	tagColor.textColor = tagColor.textColor || "#696969"; // Dim Gray
	tagColor.borderColor = tagColor.borderColor || "#696969"; // Dim Gray
	tagColor.bgColor = tagColor.bgColor || "#C0C0C0"; // Silver
