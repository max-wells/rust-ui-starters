...
use crate::registry::{
    demos::demo_extensions::demo_cards_slider::DemoCardsSlider,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cards_slider.json");

#[component]
pub fn MdxDemoCardsSlider() -> impl IntoView {
