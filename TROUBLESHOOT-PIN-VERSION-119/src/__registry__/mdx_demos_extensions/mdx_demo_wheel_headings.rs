...
use crate::registry::{
    demos::demo_extensions::demo_wheel_headings::DemoWheelHeadings,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_wheel_headings.json");

#[component]
pub fn MdxDemoWheelHeadings() -> impl IntoView {
