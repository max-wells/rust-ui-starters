...
use crate::registry::{
    demos::demo_extensions::demo_gallery_clickable_transitions::DemoGalleryClickableTransitions,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_gallery_clickable_transitions.json");

#[component]
pub fn MdxDemoGalleryClickableTransitions() -> impl IntoView {
        ...
        <PrimitiveTabsRoot default_value="tab1">
            ...
            <PrimitiveTabsContent attr:class=CLASS_TABS_CONTENT value="tab1">
                <div attr:class=CLASS_PREVIEW>
                    <DemoGalleryClickableTransitions />
                </div>
