...
use crate::registry::{
    demos::demo_extensions::demo_css_pill_lighthouse::DemoCssPillLighthouse,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_css_pill_lighthouse.json");

#[component]
pub fn MdxDemoCssPillLighthouse() -> impl IntoView {
