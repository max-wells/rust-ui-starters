...
use crate::registry::{
    demos::demo_extensions::demo_scroll_light::DemoScrollLight,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_scroll_light.json");

#[component]
pub fn MdxDemoScrollLight() -> impl IntoView {
