...
use crate::registry::{
    demos::demo_extensions::demo_universe_rotating::DemoUniverseRotating,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_universe_rotating.json");

#[component]
pub fn MdxDemoUniverseRotating() -> impl IntoView {
