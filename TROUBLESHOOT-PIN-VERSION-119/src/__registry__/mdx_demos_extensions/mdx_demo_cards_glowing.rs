...
use crate::registry::{
    demos::demo_extensions::demo_cards_glowing::DemoCardsGlowing,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cards_glowing.json");

#[component]
pub fn MdxDemoCardsGlowing() -> impl IntoView {
