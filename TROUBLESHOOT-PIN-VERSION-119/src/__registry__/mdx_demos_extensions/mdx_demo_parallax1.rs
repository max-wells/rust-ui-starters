...
use crate::registry::{
    demos::demo_extensions::demo_parallax1::DemoParallax1,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_parallax1.json");

#[component]
pub fn MdxDemoParallax1() -> impl IntoView {
