...
use crate::registry::{
    demos::demo_extensions::demo_masonry::DemoMasonry,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_masonry.json");

#[component]
pub fn MdxDemoMasonry() -> impl IntoView {
