...
use crate::registry::{
    demos::demo_extensions::demo_cards_follow_shadow::DemoCardsFollowShadow,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cards_follow_shadow.json");

#[component]
pub fn MdxDemoCardsFollowShadow() -> impl IntoView {
