...
use crate::registry::{
    demos::demo_extensions::demo_card_wobble::DemoCardWobble,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_card_wobble.json");

#[component]
pub fn MdxDemoCardWobble() -> impl IntoView {
