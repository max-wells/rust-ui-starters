...
use crate::registry::{
    demos::demo_extensions::demo_hamburger_menu::DemoHamburgerMenu,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_hamburger_menu.json");

#[component]
pub fn MdxDemoHamburgerMenu() -> impl IntoView {
