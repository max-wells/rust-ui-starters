...
use crate::registry::{
    demos::demo_extensions::demo_docker::DemoDocker,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_docker.json");

#[component]
pub fn MdxDemoDocker() -> impl IntoView {
