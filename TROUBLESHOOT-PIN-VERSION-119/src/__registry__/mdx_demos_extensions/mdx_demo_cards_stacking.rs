...
use crate::registry::{
    demos::demo_extensions::demo_cards_stacking::DemoCardsStacking,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cards_stacking.json");

#[component]
pub fn MdxDemoCardsStacking() -> impl IntoView {
