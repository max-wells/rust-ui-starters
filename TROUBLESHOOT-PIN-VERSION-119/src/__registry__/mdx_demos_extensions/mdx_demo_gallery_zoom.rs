...
use crate::registry::{
    demos::demo_extensions::demo_gallery_zoom::DemoGalleryZoom,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_gallery_zoom.json");

#[component]
pub fn MdxDemoGalleryZoom() -> impl IntoView {
