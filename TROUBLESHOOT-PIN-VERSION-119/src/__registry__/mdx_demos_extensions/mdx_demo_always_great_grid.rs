...
use crate::registry::{
    demos::demo_extensions::demo_always_great_grid::DemoAlwaysGreatGrid,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_always_great_grid.json");

#[component]
pub fn MdxDemoAlwaysGreatGrid() -> impl IntoView {
