...
use crate::registry::{
    demos::demo_extensions::demo_radar_mini::DemoRadarMini,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_radar_mini.json");

#[component]
pub fn MdxDemoRadarMini() -> impl IntoView {
