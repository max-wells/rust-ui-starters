...
use crate::registry::{
    demos::demo_extensions::demo_cta_animation_on_hover::DemoCtaAnimationOnHover,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cta_animation_on_hover.json");

#[component]
pub fn MdxDemoCtaAnimationOnHover() -> impl IntoView {
