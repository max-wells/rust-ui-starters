...
use crate::registry::{
    demos::demo_extensions::demo_carousel3d_rotating::DemoCarousel3dRotating,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_carousel3d_rotating.json");

#[component]
pub fn MdxDemoCarousel3dRotating() -> impl IntoView {
