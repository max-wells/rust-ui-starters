...
use crate::registry::{
    demos::demo_extensions::demo_tabs_shadow::DemoTabsShadow,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_tabs_shadow.json");

#[component]
pub fn MdxDemoTabsShadow() -> impl IntoView {
