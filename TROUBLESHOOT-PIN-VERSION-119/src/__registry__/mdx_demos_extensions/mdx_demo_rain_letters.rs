...
use crate::registry::{
    demos::demo_extensions::demo_rain_letters::DemoRainLetters,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_rain_letters.json");

#[component]
pub fn MdxDemoRainLetters() -> impl IntoView {
