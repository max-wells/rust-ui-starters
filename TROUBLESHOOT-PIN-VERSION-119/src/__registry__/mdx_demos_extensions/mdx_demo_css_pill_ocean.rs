...
use crate::registry::{
    demos::demo_extensions::demo_css_pill_ocean::DemoCssPillOcean,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_css_pill_ocean.json");

#[component]
pub fn MdxDemoCssPillOcean() -> impl IntoView {
