...
use crate::registry::{
    demos::demo_extensions::demo_css_pill_mountain::DemoCssPillMountain,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_css_pill_mountain.json");

#[component]
pub fn MdxDemoCssPillMountain() -> impl IntoView {
