...
use crate::registry::{
    demos::demo_extensions::demo_select_price_table::DemoSelectPriceTable,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_select_price_table.json");

#[component]
pub fn MdxDemoSelectPriceTable() -> impl IntoView {
