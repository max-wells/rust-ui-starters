...
use crate::registry::{
    demos::demo_extensions::demo_card_focus::DemoCardFocus,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_card_focus.json");

#[component]
pub fn MdxDemoCardFocus() -> impl IntoView {
