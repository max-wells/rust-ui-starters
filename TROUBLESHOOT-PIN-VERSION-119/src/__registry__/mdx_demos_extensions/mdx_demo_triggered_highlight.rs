...
use crate::registry::{
    demos::demo_extensions::demo_triggered_highlight::DemoTriggeredHighlight,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_triggered_highlight.json");

#[component]
pub fn MdxDemoTriggeredHighlight() -> impl IntoView {
