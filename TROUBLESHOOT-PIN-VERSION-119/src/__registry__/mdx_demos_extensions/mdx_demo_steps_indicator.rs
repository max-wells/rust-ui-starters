...
use crate::registry::{
    demos::demo_extensions::demo_steps_indicator::DemoStepsIndicator,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_steps_indicator.json");

#[component]
pub fn MdxDemoStepsIndicator() -> impl IntoView {
