...
use crate::registry::{
    demos::demo_extensions::demo_particles_vercel::DemoParticlesVercel,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_particles_vercel.json");

#[component]
pub fn MdxDemoParticlesVercel() -> impl IntoView {
