...
use crate::registry::{
    demos::demo_extensions::demo_cards_repushing::DemoCardsRepushing,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cards_repushing.json");

#[component]
pub fn MdxDemoCardsRepushing() -> impl IntoView {
