...
use crate::registry::{
    demos::demo_extensions::demo_card3d_flip_rotation::DemoCard3dFlipRotation,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_card3d_flip_rotation.json");

#[component]
pub fn MdxDemoCard3dFlipRotation() -> impl IntoView {
