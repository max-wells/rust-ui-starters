...
use crate::registry::{
    demos::demo_extensions::demo_cursor_multi_color::DemoCursorMultiColor,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cursor_multi_color.json");

#[component]
pub fn MdxDemoCursorMultiColor() -> impl IntoView {
