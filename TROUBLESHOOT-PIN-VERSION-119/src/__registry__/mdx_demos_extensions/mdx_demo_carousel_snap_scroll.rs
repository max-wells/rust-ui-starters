...
use crate::registry::{
    demos::demo_extensions::demo_carousel_snap_scroll::DemoCarouselSnapScroll,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_carousel_snap_scroll.json");

#[component]
pub fn MdxDemoCarouselSnapScroll() -> impl IntoView {
