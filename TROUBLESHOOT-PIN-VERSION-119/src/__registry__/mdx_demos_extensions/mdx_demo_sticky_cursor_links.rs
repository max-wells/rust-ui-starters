...
use crate::registry::{
    demos::demo_extensions::demo_sticky_cursor_links::DemoStickyCursorLinks,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_sticky_cursor_links.json");

#[component]
pub fn MdxDemoStickyCursorLinks() -> impl IntoView {
