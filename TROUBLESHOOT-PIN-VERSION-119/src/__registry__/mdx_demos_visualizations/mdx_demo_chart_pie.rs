...
use crate::registry::{
    demos::demo_visualizations::demo_chart_pie::DemoChartPie,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_pie.json");

#[component]
pub fn MdxDemoChartPie() -> impl IntoView {
