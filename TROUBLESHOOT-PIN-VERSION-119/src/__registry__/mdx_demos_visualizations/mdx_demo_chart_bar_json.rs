...
use crate::registry::{
    demos::demo_visualizations::demo_chart_bar_json::DemoChartBarJson,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_bar_json.json");

#[component]
pub fn MdxDemoChartBarJson() -> impl IntoView {
