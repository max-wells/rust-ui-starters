...
use crate::registry::{
    demos::demo_visualizations::demo_chart_scatter::DemoChartScatter,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_scatter.json");

#[component]
pub fn MdxDemoChartScatter() -> impl IntoView {
