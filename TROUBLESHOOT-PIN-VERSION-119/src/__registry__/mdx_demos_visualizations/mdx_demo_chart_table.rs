...
use crate::registry::{
    demos::demo_visualizations::demo_chart_table::DemoChartTable,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_table.json");

#[component]
pub fn MdxDemoChartTable() -> impl IntoView {
