...
use crate::registry::{
    demos::demo_visualizations::demo_chart_candlesticks::DemoChartCandlesticks,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_candlesticks.json");

#[component]
pub fn MdxDemoChartCandlesticks() -> impl IntoView {
