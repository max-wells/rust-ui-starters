...
use crate::registry::{
    demos::demo_visualizations::demo_chart_line::DemoChartLine,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_line.json");

#[component]
pub fn MdxDemoChartLine() -> impl IntoView {
