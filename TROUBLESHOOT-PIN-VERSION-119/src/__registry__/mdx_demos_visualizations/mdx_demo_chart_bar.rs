...
use crate::registry::{
    demos::demo_visualizations::demo_chart_bar::DemoChartBar,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_bar.json");

#[component]
pub fn MdxDemoChartBar() -> impl IntoView {
