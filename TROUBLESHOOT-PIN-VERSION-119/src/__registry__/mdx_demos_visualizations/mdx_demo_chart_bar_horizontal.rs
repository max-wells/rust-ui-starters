...
use crate::registry::{
    demos::demo_visualizations::demo_chart_bar_horizontal::DemoChartBarHorizontal,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_chart_bar_horizontal.json");

#[component]
pub fn MdxDemoChartBarHorizontal() -> impl IntoView {
