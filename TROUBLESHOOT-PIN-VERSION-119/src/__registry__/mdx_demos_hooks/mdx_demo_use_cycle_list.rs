...
use crate::registry::{
    demos::demo_hooks::demo_use_cycle_list::DemoUseCycleList,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_cycle_list.json");

#[component]
pub fn MdxDemoUseCycleList() -> impl IntoView {
