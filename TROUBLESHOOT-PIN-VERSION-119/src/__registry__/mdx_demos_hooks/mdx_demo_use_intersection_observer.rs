...
use crate::registry::{
    demos::demo_hooks::demo_use_intersection_observer::DemoUseIntersectionObserver,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_intersection_observer.json");

#[component]
pub fn MdxDemoUseIntersectionObserver() -> impl IntoView {
