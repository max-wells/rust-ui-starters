...
use crate::registry::{
    demos::demo_hooks::demo_use_display_media::DemoUseDisplayMedia,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_display_media.json");

#[component]
pub fn MdxDemoUseDisplayMedia() -> impl IntoView {
