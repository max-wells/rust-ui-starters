...
use crate::registry::{
    demos::demo_hooks::demo_use_mouse::DemoUseMouse,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_mouse.json");

#[component]
pub fn MdxDemoUseMouse() -> impl IntoView {
