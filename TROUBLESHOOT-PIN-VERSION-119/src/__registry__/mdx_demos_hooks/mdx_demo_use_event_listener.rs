...
use crate::registry::{
    demos::demo_hooks::demo_use_event_listener::DemoUseEventListener,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_event_listener.json");

#[component]
pub fn MdxDemoUseEventListener() -> impl IntoView {
