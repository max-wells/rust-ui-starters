...
use crate::registry::{
    demos::demo_hooks::demo_use_floating_size::DemoUseFloatingSize,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_floating_size.json");

#[component]
pub fn MdxDemoUseFloatingSize() -> impl IntoView {
