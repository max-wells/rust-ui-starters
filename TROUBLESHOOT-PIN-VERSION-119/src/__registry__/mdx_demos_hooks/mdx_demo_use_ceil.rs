...
use crate::registry::{
    demos::demo_hooks::demo_use_ceil::DemoUseCeil,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_ceil.json");

#[component]
pub fn MdxDemoUseCeil() -> impl IntoView {
