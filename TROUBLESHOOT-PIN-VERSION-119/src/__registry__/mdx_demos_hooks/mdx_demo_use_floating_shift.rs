...
use crate::registry::{
    demos::demo_hooks::demo_use_floating_shift::DemoUseFloatingShift,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_floating_shift.json");

#[component]
pub fn MdxDemoUseFloatingShift() -> impl IntoView {
