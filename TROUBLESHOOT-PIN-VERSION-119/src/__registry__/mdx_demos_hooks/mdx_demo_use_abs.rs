...
use crate::registry::{
    demos::demo_hooks::demo_use_abs::DemoUseAbs,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_abs.json");

#[component]
pub fn MdxDemoUseAbs() -> impl IntoView {
