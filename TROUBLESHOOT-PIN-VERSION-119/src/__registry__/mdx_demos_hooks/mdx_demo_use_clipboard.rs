...
use crate::registry::{
    demos::demo_hooks::demo_use_clipboard::DemoUseClipboard,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_clipboard.json");

#[component]
pub fn MdxDemoUseClipboard() -> impl IntoView {
