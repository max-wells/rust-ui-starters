...
use crate::registry::{
    demos::demo_hooks::demo_use_prefers_reduced_motion::DemoUsePrefersReducedMotion,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_prefers_reduced_motion.json");

#[component]
pub fn MdxDemoUsePrefersReducedMotion() -> impl IntoView {
