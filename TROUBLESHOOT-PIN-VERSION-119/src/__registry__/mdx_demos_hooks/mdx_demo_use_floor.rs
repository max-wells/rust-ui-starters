...
use crate::registry::{
    demos::demo_hooks::demo_use_floor::DemoUseFloor,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_floor.json");

#[component]
pub fn MdxDemoUseFloor() -> impl IntoView {
