...
use crate::registry::{
    demos::demo_hooks::demo_use_element_bounding::DemoUseElementBounding,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_element_bounding.json");

#[component]
pub fn MdxDemoUseElementBounding() -> impl IntoView {
