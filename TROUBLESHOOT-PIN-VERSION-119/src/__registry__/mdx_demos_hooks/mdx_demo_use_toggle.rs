...
use crate::registry::{
    demos::demo_hooks::demo_use_toggle::DemoUseToggle,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_toggle.json");

#[component]
pub fn MdxDemoUseToggle() -> impl IntoView {
