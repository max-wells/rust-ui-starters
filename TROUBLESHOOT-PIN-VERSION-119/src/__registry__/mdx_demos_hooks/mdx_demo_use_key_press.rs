...
use crate::registry::{
    demos::demo_hooks::demo_use_key_press::DemoUseKeyPress,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_key_press.json");

#[component]
pub fn MdxDemoUseKeyPress() -> impl IntoView {
