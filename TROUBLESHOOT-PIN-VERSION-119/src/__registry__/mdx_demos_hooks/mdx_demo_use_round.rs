...
use crate::registry::{
    demos::demo_hooks::demo_use_round::DemoUseRound,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_round.json");

#[component]
pub fn MdxDemoUseRound() -> impl IntoView {
