...
use crate::registry::{
    demos::demo_hooks::demo_use_watch_throttled::DemoUseWatchThrottled,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_watch_throttled.json");

#[component]
pub fn MdxDemoUseWatchThrottled() -> impl IntoView {
