...
use crate::registry::{
    demos::demo_hooks::demo_use_throttle::DemoUseThrottle,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_throttle.json");

#[component]
pub fn MdxDemoUseThrottle() -> impl IntoView {
