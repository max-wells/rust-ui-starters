...
use crate::registry::{
    demos::demo_hooks::demo_use_intl_number_format::DemoUseIntlNumberFormat,
...
const JSON_CONTENT: &str =
    include_str!("../../../public/registry/styles/default/demo_use_intel_number_format.json");

#[component]
pub fn MdxDemoUseIntlNumberFormat() -> impl IntoView {
    ...
    view! {
        <PrimitiveTabsRoot default_value="tab1">
            <PrimitiveTabsList
                attr:class=CLASS_TABS_LIST
                attr:aria-label="Rust UI - Preview and Code"
            >
...
const CLASS_PREVIEW: &str =
    "flex justify-center items-center rounded-md border min-h-[370px] bg-background w-full";
