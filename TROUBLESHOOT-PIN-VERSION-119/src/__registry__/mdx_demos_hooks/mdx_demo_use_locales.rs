...
use crate::registry::{
    demos::demo_hooks::demo_use_locales::DemoUseLocales,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_locales.json");

#[component]
pub fn MdxDemoUseLocales() -> impl IntoView {
