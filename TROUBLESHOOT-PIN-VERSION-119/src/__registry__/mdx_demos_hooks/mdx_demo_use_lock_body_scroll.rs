...
use crate::registry::{
    demos::demo_hooks::demo_use_lock_body_scroll::DemoUseLockBodyScroll,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_lock_body_scroll.json");

#[component]
pub fn MdxDemoUseLockBodyScroll() -> impl IntoView {
