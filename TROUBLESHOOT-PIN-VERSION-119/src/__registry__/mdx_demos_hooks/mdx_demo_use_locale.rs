...
use crate::registry::{
    demos::demo_hooks::demo_use_locale::DemoUseLocale,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_locale.json");

#[component]
pub fn MdxDemoUseLocale() -> impl IntoView {
