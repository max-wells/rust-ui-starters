...
use crate::registry::{
    demos::demo_hooks::demo_use_debounce::DemoUseDebounce,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_debounce.json");

#[component]
pub fn MdxDemoUseDebounce() -> impl IntoView {
