...
use crate::registry::{
    demos::demo_hooks::demo_use_mouse_in_element::DemoUseMouseInElement,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_mouse_in_element.json");

#[component]
pub fn MdxDemoUseMouseInElement() -> impl IntoView {
