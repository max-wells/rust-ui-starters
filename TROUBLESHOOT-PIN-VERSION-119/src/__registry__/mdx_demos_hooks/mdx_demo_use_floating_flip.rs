...
use crate::registry::{
    demos::demo_hooks::demo_use_floating_flip::DemoUseFloatingFlip,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_floating_flip.json");

#[component]
pub fn MdxDemoUseFloatingFlip() -> impl IntoView {
