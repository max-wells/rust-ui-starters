...
use crate::registry::{
    demos::demo_hooks::demo_use_permission::DemoUsePermission,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_permission.json");

#[component]
pub fn MdxDemoUsePermission() -> impl IntoView {
