...
use crate::registry::{
    demos::demo_hooks::demo_use_interval::DemoUseInterval,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_interval.json");

#[component]
pub fn MdxDemoUseInterval() -> impl IntoView {
