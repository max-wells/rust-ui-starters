...
use crate::registry::{
    demos::demo_hooks::demo_use_throttle_fn::DemoUseThrottleFn,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_throttle_fn.json");

#[component]
pub fn MdxDemoUseThrottleFn() -> impl IntoView {
