...
use crate::registry::{
    demos::demo_hooks::demo_use_idle::DemoUseIdle,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_idle.json");

#[component]
pub fn MdxDemoUseIdle() -> impl IntoView {
