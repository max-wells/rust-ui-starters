...
use crate::registry::{
    demos::demo_hooks::demo_use_mutation_observer::DemoUseMutationObserver,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_mutation_observer.json");

#[component]
pub fn MdxDemoUseMutationObserver() -> impl IntoView {
