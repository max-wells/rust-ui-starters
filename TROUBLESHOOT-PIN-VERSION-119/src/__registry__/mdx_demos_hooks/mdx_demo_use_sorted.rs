...
use crate::registry::{
    demos::demo_hooks::demo_use_sorted::DemoUseSorted,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_sorted.json");

#[component]
pub fn MdxDemoUseSorted() -> impl IntoView {
