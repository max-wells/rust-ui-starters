...
use crate::registry::{
    demos::demo_hooks::demo_use_broadcast_channel::DemoUseBroadcastChannel,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_broadcast_channel.json");

#[component]
pub fn MdxDemoUseBroadcastChannel() -> impl IntoView {
