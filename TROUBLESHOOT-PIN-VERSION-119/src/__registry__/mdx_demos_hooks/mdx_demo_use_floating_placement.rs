...
use crate::registry::{
    demos::demo_hooks::demo_use_floating_placement::DemoUseFloatingPlacement,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_floating_placement.json");

#[component]
pub fn MdxDemoUseFloatingPlacement() -> impl IntoView {
