...
use crate::registry::{
    demos::demo_hooks::demo_use_window_scroll::DemoUseWindowScroll,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_window_scroll.json");

#[component]
pub fn MdxDemoUseWindowScroll() -> impl IntoView {
