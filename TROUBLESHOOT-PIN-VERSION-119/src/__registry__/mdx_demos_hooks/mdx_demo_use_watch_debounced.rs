...
use crate::registry::{
    demos::demo_hooks::demo_use_watch_debounced::DemoUseWatchDebounced,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_watch_debounced.json");

#[component]
pub fn MdxDemoUseWatchDebounced() -> impl IntoView {
