...
use crate::registry::{
    demos::demo_hooks::demo_use_interval_fn::DemoUseIntervalFn,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_interval_fn.json");

#[component]
pub fn MdxDemoUseIntervalFn() -> impl IntoView {
