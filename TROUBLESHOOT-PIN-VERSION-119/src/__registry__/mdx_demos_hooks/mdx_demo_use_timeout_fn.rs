...
use crate::registry::{
    demos::demo_hooks::demo_use_timeout_fn::DemoUseTimeoutFn,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_timeout_fn.json");

#[component]
pub fn MdxDemoUseTimeoutFn() -> impl IntoView {
