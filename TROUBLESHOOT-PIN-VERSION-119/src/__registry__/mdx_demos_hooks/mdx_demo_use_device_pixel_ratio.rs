...
use crate::registry::{
    demos::demo_hooks::demo_use_device_pixel_ratio::DemoUseDevicePixelRatio,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_device_pixel_ratio.json");

#[component]
pub fn MdxDemoUseDevicePixelRatio() -> impl IntoView {
