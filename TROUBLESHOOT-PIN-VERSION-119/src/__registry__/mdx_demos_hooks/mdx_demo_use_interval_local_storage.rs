...
use crate::registry::{
    demos::demo_hooks::demo_use_interval_local_storage::DemoUseIntervalLocalStorage,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_interval_local_storage.json");

#[component]
pub fn MdxDemoUseIntervalLocalStorage() -> impl IntoView {
