...
use crate::registry::{
    demos::demo_hooks::demo_use_drop_zone::DemoUseDropZone,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_drop_zone.json");

#[component]
pub fn MdxDemoUseDropZone() -> impl IntoView {
