...
use crate::registry::{
    demos::demo_hooks::demo_use_window_focus::DemoUseWindowFocus,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_window_focus.json");

#[component]
pub fn MdxDemoUseWindowFocus() -> impl IntoView {
