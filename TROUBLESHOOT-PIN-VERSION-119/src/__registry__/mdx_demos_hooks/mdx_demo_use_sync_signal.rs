...
use crate::registry::{
    demos::demo_hooks::demo_use_sync_signal::DemoUseSyncSignal,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_sync_signal.json");

#[component]
pub fn MdxDemoUseSyncSignal() -> impl IntoView {
