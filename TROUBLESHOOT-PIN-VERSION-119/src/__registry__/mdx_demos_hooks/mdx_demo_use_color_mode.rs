...
use crate::registry::{
    demos::demo_hooks::demo_use_color_mode::DemoUseColorMode,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_color_mode.json");

#[component]
pub fn MdxDemoUseColorMode() -> impl IntoView {
