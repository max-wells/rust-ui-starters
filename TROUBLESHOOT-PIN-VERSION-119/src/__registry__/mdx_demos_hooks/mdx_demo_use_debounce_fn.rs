...
use crate::registry::{
    demos::demo_hooks::demo_use_debounce_fn::DemoUseDebounceFn,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_debounce_fn.json");

#[component]
pub fn MdxDemoUseDebounceFn() -> impl IntoView {
