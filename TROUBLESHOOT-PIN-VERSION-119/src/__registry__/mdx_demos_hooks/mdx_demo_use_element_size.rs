...
use crate::registry::{
    demos::demo_hooks::demo_use_element_size::DemoUseElementSize,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_element_size.json");

#[component]
pub fn MdxDemoUseElementSize() -> impl IntoView {
