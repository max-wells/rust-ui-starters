...
use crate::registry::{
    demos::demo_hooks::demo_use_or::DemoUseOr,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_or.json");

#[component]
pub fn MdxDemoUseOr() -> impl IntoView {
