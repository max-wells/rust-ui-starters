...
use crate::registry::{
    demos::demo_hooks::demo_use_window_size::DemoUseWindowSize,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_window_size.json");

#[component]
pub fn MdxDemoUseWindowSize() -> impl IntoView {
