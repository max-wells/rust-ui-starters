...
use crate::registry::{
    demos::demo_hooks::demo_use_breakpoints::DemoUseBreakpoints,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_breakpoints.json");

#[component]
pub fn MdxDemoUseBreakpoints() -> impl IntoView {
