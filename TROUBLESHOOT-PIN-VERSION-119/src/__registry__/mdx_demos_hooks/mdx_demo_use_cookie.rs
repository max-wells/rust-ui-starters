...
use crate::registry::{
    demos::demo_hooks::demo_use_cookie::DemoUseCookie,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_cookie.json");

#[component]
pub fn MdxDemoUseCookie() -> impl IntoView {
