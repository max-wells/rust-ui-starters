...
use crate::registry::{
    demos::demo_hooks::demo_use_and::DemoUseAnd,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_and.json");

#[component]
pub fn MdxDemoUseAnd() -> impl IntoView {
