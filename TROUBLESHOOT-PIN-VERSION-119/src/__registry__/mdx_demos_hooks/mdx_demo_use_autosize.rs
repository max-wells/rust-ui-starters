...
use crate::registry::{
    demos::demo_hooks::demo_use_autosize::DemoUseAutosize,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_autosize.json");

#[component]
pub fn MdxDemoUseAutosize() -> impl IntoView {
