...
use crate::registry::{
    demos::demo_hooks::demo_use_hover::DemoUseHover,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_hover.json");

#[component]
pub fn MdxDemoUseHover() -> impl IntoView {
