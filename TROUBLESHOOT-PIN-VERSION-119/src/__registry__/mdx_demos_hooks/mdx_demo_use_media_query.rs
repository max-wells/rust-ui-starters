...
use crate::registry::{
    demos::demo_hooks::demo_use_media_query::DemoUseMediaQuery,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_media_query.json");

#[component]
pub fn MdxDemoUseMediaQuery() -> impl IntoView {
