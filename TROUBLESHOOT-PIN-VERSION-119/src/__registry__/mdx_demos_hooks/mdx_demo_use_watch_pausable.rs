...
use crate::registry::{
    demos::demo_hooks::demo_use_watch_pausable::DemoUseWatchPausable,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_watch_pausable.json");

#[component]
pub fn MdxDemoUseWatchPausable() -> impl IntoView {
