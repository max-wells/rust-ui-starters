...
use crate::registry::{
    demos::demo_hooks::demo_use_not::DemoUseNot,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_not.json");

#[component]
pub fn MdxDemoUseNot() -> impl IntoView {
