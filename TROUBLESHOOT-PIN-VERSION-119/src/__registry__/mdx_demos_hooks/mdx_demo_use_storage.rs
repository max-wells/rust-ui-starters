...
use crate::registry::{
    demos::demo_hooks::demo_use_storage::DemoUseStorage,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_storage.json");

#[component]
pub fn MdxDemoUseStorage() -> impl IntoView {
