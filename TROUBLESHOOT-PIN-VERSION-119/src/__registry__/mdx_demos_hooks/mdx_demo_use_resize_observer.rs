...
use crate::registry::{
    demos::demo_hooks::demo_use_resize_observer::DemoUseResizeObserver,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_resize_observer.json");

#[component]
pub fn MdxDemoUseResizeObserver() -> impl IntoView {
