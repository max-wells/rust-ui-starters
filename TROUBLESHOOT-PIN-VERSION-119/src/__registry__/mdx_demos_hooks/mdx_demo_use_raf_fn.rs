...
use crate::registry::{
    demos::demo_hooks::demo_use_raf_fn::DemoUseRafFn,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_raf_fn.json");

#[component]
pub fn MdxDemoUseRafFn() -> impl IntoView {
