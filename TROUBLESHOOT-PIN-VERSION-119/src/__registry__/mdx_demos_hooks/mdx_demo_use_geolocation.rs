...
use crate::registry::{
    demos::demo_hooks::demo_use_geolocation::DemoUseGeolocation,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_geolocation.json");

#[component]
pub fn MdxDemoUseGeolocation() -> impl IntoView {
