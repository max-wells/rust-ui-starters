...
use crate::registry::{
    demos::demo_hooks::demo_use_css_var::DemoUseCssVar,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_css_var.json");

#[component]
pub fn MdxDemoUseCssVar() -> impl IntoView {
