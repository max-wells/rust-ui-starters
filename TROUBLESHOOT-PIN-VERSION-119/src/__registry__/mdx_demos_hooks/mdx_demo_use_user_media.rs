...
use crate::registry::{
    demos::demo_hooks::demo_use_user_media::DemoUseUserMedia,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_user_media.json");

#[component]
pub fn MdxDemoUseUserMedia() -> impl IntoView {
