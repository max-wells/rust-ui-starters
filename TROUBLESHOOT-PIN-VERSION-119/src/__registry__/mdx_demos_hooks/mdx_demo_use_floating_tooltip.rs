...
use crate::registry::{
    demos::demo_hooks::demo_use_floating_tooltip::DemoUseFloatingTooltip,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_floating_tooltip.json");

#[component]
pub fn MdxDemoUseFloatingTooltip() -> impl IntoView {
