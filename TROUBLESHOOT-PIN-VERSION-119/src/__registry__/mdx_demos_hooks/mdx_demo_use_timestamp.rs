...
use crate::registry::{
    demos::demo_hooks::demo_use_timestamp::DemoUseTimestamp,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_timestamp.json");

#[component]
pub fn MdxDemoUseTimestamp() -> impl IntoView {
