...
use crate::registry::{
    demos::demo_hooks::demo_use_click_outside::DemoUseClickOutside,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_use_click_outside.json");

#[component]
pub fn MdxDemoUseClickOutside() -> impl IntoView {
