...
use crate::registry::{
    demos::demo_primitives::demo_toggle::DemoToggle,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_toggle.json");

#[component]
pub fn MdxDemoToggle() -> impl IntoView {
