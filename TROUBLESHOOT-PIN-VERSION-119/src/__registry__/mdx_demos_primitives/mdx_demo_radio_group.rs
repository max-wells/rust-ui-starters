...
use crate::registry::{
    demos::demo_primitives::demo_radio_group::DemoRadioGroup,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_radio_group.json");

#[component]
pub fn MdxDemoRadioGroup() -> impl IntoView {
