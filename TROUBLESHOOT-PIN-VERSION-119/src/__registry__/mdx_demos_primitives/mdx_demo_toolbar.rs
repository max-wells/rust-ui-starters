...
use crate::registry::{
    demos::demo_primitives::demo_toolbar::DemoToolbar,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_toolbar.json");

#[component]
pub fn MdxDemoToolbar() -> impl IntoView {
