...
use crate::registry::{
    demos::demo_primitives::demo_primitive_label::DemoPrimitiveLabel,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_primitive_label.json");

#[component]
pub fn MdxDemoPrimitiveLabel() -> impl IntoView {
