...
use crate::registry::{
    demos::demo_primitives::demo_progress::DemoProgress,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_progress.json");

#[component]
pub fn MdxDemoProgress() -> impl IntoView {
