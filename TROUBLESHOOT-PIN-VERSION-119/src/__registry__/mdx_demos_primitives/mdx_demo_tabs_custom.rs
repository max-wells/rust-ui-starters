...
use crate::registry::{
    demos::demo_primitives::demo_tabs_custom::DemoTabsCustom,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_tabs_custom.json");

#[component]
pub fn MdxDemoTabsCustom() -> impl IntoView {
