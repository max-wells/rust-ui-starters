...
use crate::registry::{
    demos::demo_primitives::demo_aspect_ratio::DemoAspectRatio,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_aspect_ratio.json");

#[component]
pub fn MdxDemoAspectRatio() -> impl IntoView {
