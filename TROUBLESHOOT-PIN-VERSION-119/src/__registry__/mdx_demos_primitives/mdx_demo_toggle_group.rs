...
use crate::registry::{
    demos::demo_primitives::demo_toggle_group::DemoToggleGroup,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_toggle_group.json");

#[component]
pub fn MdxDemoToggleGroup() -> impl IntoView {
