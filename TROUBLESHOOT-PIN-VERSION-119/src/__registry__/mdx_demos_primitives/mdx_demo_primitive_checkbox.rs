...
use crate::registry::{
    demos::demo_primitives::demo_primitive_checkbox::DemoPrimitiveCheckbox,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_primitive_checkbox.json");

#[component]
pub fn MdxDemoPrimitiveCheckbox() -> impl IntoView {
