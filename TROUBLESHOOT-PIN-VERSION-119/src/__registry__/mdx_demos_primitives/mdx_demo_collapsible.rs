...
use crate::registry::{
    demos::demo_primitives::demo_collapsible::DemoCollapsible,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_collapsible.json");

#[component]
pub fn MdxDemoCollapsible() -> impl IntoView {
