...
use crate::registry::{
    demos::demo_primitives::demo_slider::DemoSlider,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_slider.json");

#[component]
pub fn MdxDemoSlider() -> impl IntoView {
