...
use crate::registry::{
    demos::demo_primitives::demo_avatar::DemoAvatar,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_avatar.json");

#[component]
pub fn MdxDemoAvatar() -> impl IntoView {
