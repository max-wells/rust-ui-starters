...
use crate::registry::{
    demos::demo_primitives::demo_toggle_custom::DemoToggleCustom,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_toggle_custom.json");

#[component]
pub fn MdxDemoToggleCustom() -> impl IntoView {
