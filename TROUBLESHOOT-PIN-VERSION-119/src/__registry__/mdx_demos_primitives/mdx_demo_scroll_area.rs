...
use crate::registry::{
    demos::demo_primitives::demo_scroll_area::DemoScrollArea,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_scroll_area.json");

#[component]
pub fn MdxDemoScrollArea() -> impl IntoView {
