...
use crate::registry::{
    demos::demo_primitives::demo_tabs::DemoTabs,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_tabs.json");

#[component]
pub fn MdxDemoTabs() -> impl IntoView {
