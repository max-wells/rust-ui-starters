...
use crate::registry::{
    demos::demo_primitives::demo_switch::DemoSwitch,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_switch.json");

#[component]
pub fn MdxDemoSwitch() -> impl IntoView {
