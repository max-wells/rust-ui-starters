...
use crate::registry::{
    demos::demo_primitives::demo_accordion::DemoAccordion,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_accordion.json");

#[component]
pub fn MdxDemoAccordion() -> impl IntoView {
