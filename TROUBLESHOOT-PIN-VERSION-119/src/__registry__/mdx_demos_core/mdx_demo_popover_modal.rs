...
use crate::registry::{
    demos::demo_core::demo_popover_modal::DemoPopoverModal,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_popover_modal.json");

#[component]
pub fn MdxDemoPopoverModal() -> impl IntoView {
