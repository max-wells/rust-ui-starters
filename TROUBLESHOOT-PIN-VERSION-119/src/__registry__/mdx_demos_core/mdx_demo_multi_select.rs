...
use crate::registry::{
    demos::demo_core::demo_multi_select::DemoMultiSelect,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_multi_select.json");

#[component]
pub fn MdxDemoMultiSelect() -> impl IntoView {
