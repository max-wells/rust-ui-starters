...
use crate::registry::{
    demos::demo_core::demo_animate::DemoAnimate,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_animate.json");

#[component]
pub fn MdxDemoAnimate() -> impl IntoView {
