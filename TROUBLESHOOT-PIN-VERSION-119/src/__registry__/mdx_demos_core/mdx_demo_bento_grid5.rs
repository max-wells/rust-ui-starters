...
use crate::registry::{
    demos::demo_core::demo_bento_grid5::DemoBentoGrid5,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_bento_grid5.json");

#[component]
pub fn MdxDemoBentoGrid5() -> impl IntoView {
