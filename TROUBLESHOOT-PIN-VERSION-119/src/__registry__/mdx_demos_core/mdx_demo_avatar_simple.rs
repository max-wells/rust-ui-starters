...
use crate::registry::{
    demos::demo_core::demo_avatar_simple::DemoAvatarSimple,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_avatar_simple.json");

#[component]
pub fn MdxDemoAvatarSimple() -> impl IntoView {
