...
use crate::registry::{
    demos::demo_core::demo_dropzone::DemoDropzone,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_dropzone.json");

#[component]
pub fn MdxDemoDropzone() -> impl IntoView {
