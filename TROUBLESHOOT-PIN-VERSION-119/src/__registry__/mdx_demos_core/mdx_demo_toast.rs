...
use crate::registry::{
    demos::demo_core::demo_toast::DemoToast,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_toast.json");

#[component]
pub fn MdxDemoToast() -> impl IntoView {
