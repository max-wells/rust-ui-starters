...
use crate::registry::{
    demos::demo_core::demo_input::DemoInput,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_input.json");

#[component]
pub fn MdxDemoInput() -> impl IntoView {
