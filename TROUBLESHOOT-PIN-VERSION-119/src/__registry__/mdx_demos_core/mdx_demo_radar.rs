...
use crate::registry::{
    demos::demo_core::demo_radar::DemoRadar,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_radar.json");

#[component]
pub fn MdxDemoRadar() -> impl IntoView {
