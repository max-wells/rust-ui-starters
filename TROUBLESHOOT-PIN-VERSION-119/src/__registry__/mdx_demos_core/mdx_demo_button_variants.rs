...
use crate::registry::{
    demos::demo_core::demo_button_variants::DemoButtonVariants,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_button_variants.json");

#[component]
pub fn MdxDemoButtonVariants() -> impl IntoView {
