...
use crate::registry::{
    demos::demo_core::demo_spotlight::DemoSpotlight,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_spotlight.json");

#[component]
pub fn MdxDemoSpotlight() -> impl IntoView {
