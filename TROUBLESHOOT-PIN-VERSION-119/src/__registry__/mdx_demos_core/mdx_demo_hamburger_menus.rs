...
use crate::registry::{
    demos::demo_core::demo_hamburger_menus::DemoHamburgerMenus,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_hamburger_menus.json");

#[component]
pub fn MdxDemoHamburgerMenus() -> impl IntoView {
