...
use crate::registry::{
    demos::demo_core::demo_blockquote::DemoBlockquote,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_blockquote.json");

#[component]
pub fn MdxDemoBlockquote() -> impl IntoView {
