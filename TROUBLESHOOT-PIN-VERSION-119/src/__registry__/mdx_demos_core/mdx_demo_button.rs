...
use crate::registry::{
    demos::demo_core::demo_button::DemoButton,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_button.json");

#[component]
pub fn MdxDemoButton() -> impl IntoView {
