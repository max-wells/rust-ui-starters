...
use crate::registry::{
    demos::demo_core::demo_text_area::DemoTextArea,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_text_area.json");

#[component]
pub fn MdxDemoTextArea() -> impl IntoView {
