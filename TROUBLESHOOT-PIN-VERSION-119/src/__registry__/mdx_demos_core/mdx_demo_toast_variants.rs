...
use crate::registry::{
    demos::demo_core::demo_toast_variants::DemoToastVariants,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_toast_variants.json");

#[component]
pub fn MdxDemoToastVariants() -> impl IntoView {
