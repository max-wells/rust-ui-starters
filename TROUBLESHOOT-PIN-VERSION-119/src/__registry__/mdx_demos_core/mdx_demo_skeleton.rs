...
use crate::registry::{
    demos::demo_core::demo_skeleton::DemoSkeleton,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_skeleton.json");

#[component]
pub fn MdxDemoSkeleton() -> impl IntoView {
