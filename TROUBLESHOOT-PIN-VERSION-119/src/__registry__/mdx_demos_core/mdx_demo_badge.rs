...
use crate::registry::{
    demos::demo_core::demo_badge::DemoBadge,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_badge.json");

#[component]
pub fn MdxDemoBadge() -> impl IntoView {
