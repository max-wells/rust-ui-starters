...
use crate::registry::{
    demos::demo_core::demo_badge_variants::DemoBadgeVariants,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_badge_variants.json");

#[component]
pub fn MdxDemoBadgeVariants() -> impl IntoView {
