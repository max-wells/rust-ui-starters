...
use crate::registry::{
    demos::demo_core::demo_button_override::DemoButtonOverride,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_button_override.json");

#[component]
pub fn MdxDemoButtonOverride() -> impl IntoView {
