...
use crate::registry::{
    demos::demo_core::demo_marquee::DemoMarquee,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_marquee.json");

#[component]
pub fn MdxDemoMarquee() -> impl IntoView {
