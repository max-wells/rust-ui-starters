...
use crate::registry::{
    demos::demo_core::demo_command_dialog::DemoCommandDialog,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_command_dialog.json");

#[component]
pub fn MdxDemoCommandDialog() -> impl IntoView {
