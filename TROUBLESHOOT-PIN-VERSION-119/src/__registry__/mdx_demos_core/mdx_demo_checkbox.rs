...
use crate::registry::{
    demos::demo_core::demo_checkbox::DemoCheckbox,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_checkbox.json");

#[component]
pub fn MdxDemoCheckbox() -> impl IntoView {
