...
use crate::registry::{
    demos::demo_core::demo_headings::DemoHeadings,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_headings.json");

#[component]
pub fn MdxDemoHeadings() -> impl IntoView {
