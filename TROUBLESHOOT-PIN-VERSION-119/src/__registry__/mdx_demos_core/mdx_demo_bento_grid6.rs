...
use crate::registry::{
    demos::demo_core::demo_bento_grid6::DemoBentoGrid6,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_bento_grid6.json");

#[component]
pub fn MdxDemoBentoGrid6() -> impl IntoView {
