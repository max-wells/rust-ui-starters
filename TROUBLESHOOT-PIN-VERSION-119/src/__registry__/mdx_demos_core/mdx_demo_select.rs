...
use crate::registry::{
    demos::demo_core::demo_select::DemoSelect,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_select.json");

#[component]
pub fn MdxDemoSelect() -> impl IntoView {
