...
use crate::registry::{
    demos::demo_core::demo_headings_animate::DemoHeadingsAnimate,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_headings_animate.json");

#[component]
pub fn MdxDemoHeadingsAnimate() -> impl IntoView {
