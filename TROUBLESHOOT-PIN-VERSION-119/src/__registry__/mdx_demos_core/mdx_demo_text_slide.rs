...
use crate::registry::{
    demos::demo_core::demo_text_slide::DemoTextSlide,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_text_slide.json");

#[component]
pub fn MdxDemoTextSlide() -> impl IntoView {
