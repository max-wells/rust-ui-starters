...
use crate::registry::{
    demos::demo_core::demo_card_tilting::DemoCardTilting,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_card_tilting.json");

#[component]
pub fn MdxDemoCardTilting() -> impl IntoView {
