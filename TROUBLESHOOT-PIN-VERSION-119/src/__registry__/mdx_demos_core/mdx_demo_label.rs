...
use crate::registry::{
    demos::demo_core::demo_label::DemoLabel,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_label.json");

#[component]
pub fn MdxDemoLabel() -> impl IntoView {
