...
use crate::registry::{
    demos::demo_core::demo_carousel_parallax::DemoCarouselParallax,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_carousel_parallax.json");

#[component]
pub fn MdxDemoCarouselParallax() -> impl IntoView {
