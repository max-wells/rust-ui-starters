...
use crate::registry::{
    demos::demo_core::demo_status_variants::DemoStatusVariants,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_status_variants.json");

#[component]
pub fn MdxDemoStatusVariants() -> impl IntoView {
