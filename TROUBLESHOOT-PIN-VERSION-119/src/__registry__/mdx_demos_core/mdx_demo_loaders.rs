...
use crate::registry::{
    demos::demo_core::demo_loaders::DemoLoaders,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_loaders.json");

#[component]
pub fn MdxDemoLoaders() -> impl IntoView {
