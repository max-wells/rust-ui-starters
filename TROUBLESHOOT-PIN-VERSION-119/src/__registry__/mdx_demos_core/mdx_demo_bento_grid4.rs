...
use crate::registry::{
    demos::demo_core::demo_bento_grid4::DemoBentoGrid4,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_bento_grid4.json");

#[component]
pub fn MdxDemoBentoGrid4() -> impl IntoView {
