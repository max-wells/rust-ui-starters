...
use crate::registry::{
    demos::demo_core::demo_command::DemoCommand,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_command.json");

#[component]
pub fn MdxDemoCommand() -> impl IntoView {
