...
use crate::registry::{
    demos::demo_core::demo_button_sizes::DemoButtonSizes,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_button_sizes.json");

#[component]
pub fn MdxDemoButtonSizes() -> impl IntoView {
