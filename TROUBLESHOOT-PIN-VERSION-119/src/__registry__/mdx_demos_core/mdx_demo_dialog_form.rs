...
use crate::registry::{
    demos::demo_core::demo_dialog_form::DemoDialogForm,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_dialog_form.json");

#[component]
pub fn MdxDemoDialogForm() -> impl IntoView {
