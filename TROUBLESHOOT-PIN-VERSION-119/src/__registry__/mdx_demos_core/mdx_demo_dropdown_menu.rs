...
use crate::registry::{
    demos::demo_core::demo_dropdown_menu::DemoDropdownMenu,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_dropdown_menu.json");

#[component]
pub fn MdxDemoDropdownMenu() -> impl IntoView {
