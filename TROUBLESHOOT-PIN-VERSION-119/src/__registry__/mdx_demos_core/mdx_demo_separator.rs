...
use crate::registry::{
    demos::demo_core::demo_separator::DemoSeparator,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_separator.json");

#[component]
pub fn MdxDemoSeparator() -> impl IntoView {
