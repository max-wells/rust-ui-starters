...
use crate::registry::{
    demos::demo_core::demo_headings_motion::DemoHeadingsMotion,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_headings_motion.json");

#[component]
pub fn MdxDemoHeadingsMotion() -> impl IntoView {
