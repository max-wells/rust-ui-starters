...
use crate::registry::{
    demos::demo_core::demo_gradient::DemoGradient,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_gradient.json");

#[component]
pub fn MdxDemoGradient() -> impl IntoView {
