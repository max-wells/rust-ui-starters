...
use crate::registry::{
    demos::demo_core::demo_meteor_effect::DemoMeteorEffect,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_meteor_effect.json");

#[component]
pub fn MdxDemoMeteorEffect() -> impl IntoView {
