...
use crate::registry::{
    demos::demo_core::demo_card3d_hover::DemoCard3dHover,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_card3d_hover.json");

#[component]
pub fn MdxDemoCard3dHover() -> impl IntoView {
