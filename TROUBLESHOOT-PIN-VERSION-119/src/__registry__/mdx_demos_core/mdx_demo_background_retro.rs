...
use crate::registry::{
    demos::demo_core::demo_background_retro::DemoBackgroundRetro,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_background_retro.json");

#[component]
pub fn MdxDemoBackgroundRetro() -> impl IntoView {
