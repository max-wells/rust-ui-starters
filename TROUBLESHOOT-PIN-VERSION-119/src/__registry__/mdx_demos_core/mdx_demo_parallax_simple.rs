...
use crate::registry::{
    demos::demo_core::demo_parallax_simple::DemoParallaxSimple,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_parallax_simple.json");

#[component]
pub fn MdxDemoParallaxSimple() -> impl IntoView {
