...
use crate::registry::{
    demos::demo_core::demo_badge_custom::DemoBadgeCustom,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_badge_custom.json");

#[component]
pub fn MdxDemoBadgeCustom() -> impl IntoView {
