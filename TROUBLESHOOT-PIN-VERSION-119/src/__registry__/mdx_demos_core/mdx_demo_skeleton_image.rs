...
use crate::registry::{
    demos::demo_core::demo_skeleton_image::DemoSkeletonImage,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_skeleton_image.json");

#[component]
pub fn MdxDemoSkeletonImage() -> impl IntoView {
