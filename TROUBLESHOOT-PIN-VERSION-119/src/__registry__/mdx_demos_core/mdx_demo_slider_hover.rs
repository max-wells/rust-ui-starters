...
use crate::registry::{
    demos::demo_core::demo_slider_hover::DemoSliderHover,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_slider_hover.json");

#[component]
pub fn MdxDemoSliderHover() -> impl IntoView {
