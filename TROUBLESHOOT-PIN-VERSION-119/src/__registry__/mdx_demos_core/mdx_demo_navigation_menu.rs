...
use crate::registry::{
    demos::demo_core::demo_navigation_menu::DemoNavigationMenu,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_navigation_menu.json");

#[component]
pub fn MdxDemoNavigationMenu() -> impl IntoView {
