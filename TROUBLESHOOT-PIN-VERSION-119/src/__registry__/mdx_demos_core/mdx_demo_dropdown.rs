...
use crate::registry::{
    demos::demo_core::demo_dropdown::DemoDropdown,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_dropdown.json");

#[component]
pub fn MdxDemoDropdown() -> impl IntoView {
