...
use crate::registry::{
    demos::demo_core::demo_sheet_directions::DemoSheetDirections,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_sheet_directions.json");

#[component]
pub fn MdxDemoSheetDirections() -> impl IntoView {
