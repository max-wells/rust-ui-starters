...
use crate::registry::{
    demos::demo_core::demo_sheet::DemoSheet,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_sheet.json");

#[component]
pub fn MdxDemoSheet() -> impl IntoView {
