...
use crate::registry::{
    demos::demo_core::demo_headings_variants::DemoHeadingsVariants,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_headings_variants.json");

#[component]
pub fn MdxDemoHeadingsVariants() -> impl IntoView {
