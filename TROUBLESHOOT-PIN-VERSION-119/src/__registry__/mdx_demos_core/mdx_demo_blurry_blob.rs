...
use crate::registry::{
    demos::demo_core::demo_blurry_blob::DemoBlurryBlob,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_blurry_blob.json");

#[component]
pub fn MdxDemoBlurryBlob() -> impl IntoView {
