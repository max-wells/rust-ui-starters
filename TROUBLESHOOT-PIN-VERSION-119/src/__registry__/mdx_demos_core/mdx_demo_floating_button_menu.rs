...
use crate::registry::{
    demos::demo_core::demo_floating_button_menu::DemoFloatingButtonMenu,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_floating_button_menu.json");

#[component]
pub fn MdxDemoFloatingButtonMenu() -> impl IntoView {
