...
use crate::registry::{
    demos::demo_core::demo_status::DemoStatus,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_status.json");

#[component]
pub fn MdxDemoStatus() -> impl IntoView {
