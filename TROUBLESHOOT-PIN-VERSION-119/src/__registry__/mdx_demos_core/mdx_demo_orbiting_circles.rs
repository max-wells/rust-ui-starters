...
use crate::registry::{
    demos::demo_core::demo_orbiting_circles::DemoOrbitingCircles,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_orbiting_circles.json");

#[component]
pub fn MdxDemoOrbitingCircles() -> impl IntoView {
