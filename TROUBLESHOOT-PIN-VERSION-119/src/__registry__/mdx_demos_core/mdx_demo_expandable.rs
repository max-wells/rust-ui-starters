...
use crate::registry::{
    demos::demo_core::demo_expandable::DemoExpandable,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_expandable.json");

#[component]
pub fn MdxDemoExpandable() -> impl IntoView {
