...
use crate::registry::{
    demos::demo_core::demo_tooltip::DemoTooltip,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_tooltip.json");

#[component]
pub fn MdxDemoTooltip() -> impl IntoView {
