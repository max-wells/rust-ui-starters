...
use crate::registry::{
    demos::demo_core::demo_tailwind_scroll_only::DemoTailwindScrollOnly,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_tailwind_scroll_only.json");

#[component]
pub fn MdxDemoTailwindScrollOnly() -> impl IntoView {
