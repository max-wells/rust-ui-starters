...
use crate::registry::{
    demos::demo_core::demo_beam_border::DemoBeamBorder,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_beam_border.json");

#[component]
pub fn MdxDemoBeamBorder() -> impl IntoView {
