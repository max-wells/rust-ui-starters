...
use crate::registry::{
    demos::demo_core::demo_navigation_menu_complex::DemoNavigationMenuComplex,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_navigation_menu_complex.json");

#[component]
pub fn MdxDemoNavigationMenuComplex() -> impl IntoView {
