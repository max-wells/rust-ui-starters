...
use crate::registry::{
    demos::demo_core::demo_parallax_zoom_words::DemoParallaxZoomWords,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_parallax_zoom_words.json");

#[component]
pub fn MdxDemoParallaxZoomWords() -> impl IntoView {
