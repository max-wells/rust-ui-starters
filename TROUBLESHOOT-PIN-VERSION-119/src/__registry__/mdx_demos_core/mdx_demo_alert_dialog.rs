...
use crate::registry::{
    demos::demo_core::demo_alert_dialog::DemoAlertDialog,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_alert_dialog.json");

#[component]
pub fn MdxDemoAlertDialog() -> impl IntoView {
