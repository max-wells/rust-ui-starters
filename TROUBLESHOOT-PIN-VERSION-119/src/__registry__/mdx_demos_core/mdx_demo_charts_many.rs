...
use crate::registry::{
    demos::demo_core::demo_charts_many::DemoChartsMany,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_charts_many.json");

#[component]
pub fn MdxDemoChartsMany() -> impl IntoView {
