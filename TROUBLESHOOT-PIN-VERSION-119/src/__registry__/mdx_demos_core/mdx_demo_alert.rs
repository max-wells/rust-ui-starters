...
use crate::registry::{
    demos::demo_core::demo_alert::DemoAlert,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_alert.json");

#[component]
pub fn MdxDemoAlert() -> impl IntoView {
