...
use crate::registry::{
    demos::demo_core::demo_table::DemoTable,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_table.json");

#[component]
pub fn MdxDemoTable() -> impl IntoView {
