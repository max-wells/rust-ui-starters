...
use crate::registry::{
    demos::demo_core::demo_breadcrumb::DemoBreadcrumb,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_breadcrumb.json");

#[component]
pub fn MdxDemoBreadcrumb() -> impl IntoView {
