...
use crate::registry::{
    demos::demo_core::demo_animate_group::DemoAnimateGroup,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_animate_group.json");

#[component]
pub fn MdxDemoAnimateGroup() -> impl IntoView {
