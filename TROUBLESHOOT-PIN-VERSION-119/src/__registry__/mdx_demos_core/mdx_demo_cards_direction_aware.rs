...
use crate::registry::{
    demos::demo_core::demo_cards_direction_aware::DemoCardsDirectionAware,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_cards_direction_aware.json");

#[component]
pub fn MdxDemoCardsDirectionAware() -> impl IntoView {
