...
use crate::registry::{
    demos::demo_core::demo_announcement::DemoAnnouncement,
...
const JSON_CONTENT: &str = include_str!("../../../public/registry/styles/default/demo_announcement.json");

#[component]
pub fn MdxDemoAnnouncement() -> impl IntoView {
