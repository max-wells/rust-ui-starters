...
#[component]
pub fn DemoSliderHover() -> impl IntoView {
    view! {
        <div class="flex justify-center items-center min-h-screen bg-neutral-800">
            <div class="px-6 mx-auto max-w-6xl">
                <div class="flex [&:hover>div]:w-16 [&>div:hover]:w-[30rem]">
                    <div class="overflow-hidden relative h-96 shadow-lg transition-all duration-200 cursor-pointer group w-[30rem] shadow-black/30">
                        <img
                            class="object-cover h-full transition-all group-hover:scale-125 group-hover:rotate-12"
                            src="https://cdn.pixabay.com/photo/2016/01/31/19/41/apple-1172060_960_720.jpg"
                            alt=""
                        />
                        <div class="absolute inset-0 invisible bg-gradient-to-b to-black group-hover:visible from-green-500/20">
                            <div class="absolute inset-x-5 bottom-6">
                                <div class="flex gap-3 text-white">
                                    ...
                                    <div>
                                        <p class="text-xl text-gray-100 font-sembold">
                                            Beyond Builder
                                        </p>
                                        <p class="text-gray-300">Better Design</p>
                                    </div>
                                </div>
                                <div class="flex gap-3 justify-end text-gray-200">
                    ...
                    <div class="overflow-hidden relative w-16 h-96 shadow-lg transition-all duration-200 cursor-pointer group shadow-black/30">
                        <img
                            class="object-cover h-full transition-all group-hover:scale-125 group-hover:rotate-12"
            ...
            <div class="fixed right-10 bottom-10">
                <p class="text-xl font-semibold text-white">
                    Images are from <a href="https://pixabay.com" class="text-blue-500 lowercase">
                        pixabay.com
                    </a>
                </p>
            </div>
