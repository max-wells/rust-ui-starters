...
module.exports = {
	...
	theme: {
		...
		extend: {
			backgroundImage: {
				// Used for FerrisAnimate
				backgroundCustomRadial:
			...
			animation: {
				...
				//  ------------- 👇 [ANIMATE] 👇 ------------- //
				ferrisMove: "ferrisMove 8s infinite linear",
				ferrisWiggle: "ferrisWiggle 0.25s infinite",
				...
				// Blurry blob
				blurryBlob: "blurryBlob 5s infinite",
				// Toast
				toastTracker: "toastTracker ease-in-out forwards",
				// Card Feature
				...
				// Beam Border
				afterBeamBorder:
					"afterBeamBorder calc(var(--duration)*1s) infinite linear",
				// Button (extended)
				...
				// Orbiting Circles
				orbitingCircleItem:
					"orbitingCircleItem calc(var(--duration)*1s) linear infinite",
				// Background Ripple
				ripple: "ripple 3400ms ease infinite",
				// Background Retro
				backgroundRetroGrid: "backgroundRetroGrid 15s linear infinite",
				...
				// Aceternity Spotlight
				spotlightEffect: "spotlightEffect 2s ease .75s 1 forwards",
				// syntax UI
				...
				textSwiping:
					"textSwiping 12.5s cubic-bezier(0.83, 0, 0.17, 1) infinite",
				...
				typingEffect:
					"typingEffect 2s steps(20) infinite alternate, blinkTyping .7s infinite",
