...
use crate::{
    ...
    models::model_users_url::{AllTodosTagUrlFromClient, MyTodo},
    utils::hooks::queries::queries_users_url::useAllTodosFromClient,
};

#[component]
pub fn AllTodosFromClient() -> impl IntoView {
    let QueryResult {
        data,
        state,
        ..
    } = useAllTodosFromClient().use_query(|| AllTodosTagUrlFromClient);
    ...
    view! {
        <div class="flex flex-col gap-4 p-4 rounded-md bg-neutral-300">
            ...
            <h2 class="text-lg font-bold">"All Todos from client"</h2>
