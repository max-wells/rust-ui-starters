...
pub const STYLES: Styles = Styles {
    ...
    CHECKBOX_DATA_STATE_PRIMARY: "data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground",
    ...
    FOCUS_VISIBLE_RING: "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1",
